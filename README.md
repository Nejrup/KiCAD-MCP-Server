...
- `download_jlcpcb_database` - Download JLCPCB catalog from official API or public snapshot (with update-aware archive reuse)
- `search_jlcpcb_parts` - Search ~7,000,000 parts with parametric filters (Basic-first by default)
